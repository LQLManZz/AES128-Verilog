...
| `LOAD_CIPHER_KEY` | Nhận tín hiệu `expansion_en`, nạp cipher key vào Round Key Array và Module Key Expansion thành `round_key[0]` |
| `KEY_EXPAND`      | Bắt đầu quá trình sinh khóa, tạo bộ đếm `round_index`, duy trì đến khi `round_index = 10`                     |
