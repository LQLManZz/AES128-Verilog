...
| **`tb_aes_uart_wrapper.sv`**| **Modification required** | Add official **NIST SP 800-38D AES-256-GCM** test vectors (Appendix B Test Case 16) to validate 256-bit key encryption. |
