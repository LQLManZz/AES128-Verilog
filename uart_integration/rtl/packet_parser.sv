...
// Description: Deserializes, validates, and decodes binary UART packets.
//
// Packet Format:
//   Byte 0: CMD
//   Byte 1: LENGTH
...
//
// Supported Commands:
//   0x01: LOAD_KEY        (Length: 16 or 32 bytes)
//   0x02: LOAD_IV         (Length: 12 bytes = 96 bits)
//   0x03: LOAD_AAD        (Length: Multiples of 16 bytes)
//   0x04: LOAD_PLAINTEXT  (Length: Multiples of 16 bytes)
//   0x05: START_ENCRYPT   (Length: 0 bytes)
//=============================================================================
        ...
        if (!rst_n) begin
            ...
            case (state)
                ...
                ST_CHECK_CMD: begin
                    ...
                    case (cmd_reg)
                        8'h01: begin // LOAD_KEY (16 or 32 bytes)
                        ...
                        8'h02: begin // LOAD_IV (12 bytes = 96 bits)
                        ...
                        8'h03: begin // LOAD_AAD (Multiple of 16 bytes)
                        ...
                        8'h04: begin // LOAD_PLAINTEXT (Multiple of 16 bytes)
                            if ((len_reg[3:0] == 4'd0) && (len_reg > 8'd0)) begin
                                total_blocks   <= len_reg >> 4;
                                block_byte_cnt <= 4'd0;
                                state          <= ST_PAYLOAD;
                        ...
                        8'h05: begin // START_ENCRYPT (Length must be 0)
